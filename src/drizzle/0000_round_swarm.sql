...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "tasks_to_categories" (
	"task_id" integer NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "tasks_to_categories" ADD CONSTRAINT "tasks_to_categories_task_id_tasks_id_fk" FOREIGN KEY ("task_id") REFERENCES "public"."tasks"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "tasks_to_categories" ADD CONSTRAINT "tasks_to_categories_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
